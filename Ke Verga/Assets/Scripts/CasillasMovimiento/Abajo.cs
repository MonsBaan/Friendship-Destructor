...
public class Abajo : MonoBehaviour
{
    ...
    private void OnMouseDown()
    {
        ...
        if(jugador.transform.position.y > -169)
        {
            jugador.transform.position = new Vector3(jugador.transform.position.x, jugador.transform.position.y - 26, jugador.transform.position.z);
        }
